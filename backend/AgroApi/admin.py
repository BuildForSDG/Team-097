...
from .models import UserProfile, UserInterest, UserEducation, PostComment, Post, GroupMember, Group, MetaTag
#ModelAdmins
...
class PostAdmin(admin.ModelAdmin):
    list_filter = ('user', 'post_text', 'group', 'metatags', 'date_created')
